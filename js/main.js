...
cellTowers= L.geoJson.ajax("assets/airports.geojson",{
    ...
    pointToLayer: function (feature, latlng) {
        ...
        return L.marker(latlng, {icon: L.divIcon({className: 'fas fa-plane-departure marker-color-' + (id + 1).toString() })});
    },
    attribution: 'Airport Data &copy; DATA.GOV | U.S. counties &copy; Mike Bostock | Base Map &copy; CARTO | Made By Jou Ho'
}).addTo(mymap);
...
div.innerHTML += '<i class="fas fa-plane-departure marker-color-1"></i><p> Yes</p>';
div.innerHTML += '<i class="fas fa-plane-departure marker-color-2"></i><p> No</p>';
